...
class EntityImageConfigTest {
    ...
    void testEntityWithImageConfig() {
        ImageConfiguration config = new ImageConfiguration(1.5, 2.0, 0.0, RenderMode.CONFIGURED_SIZE, 0.8, true);
    ...
    void testSetImageConfig() {
        ...
        ImageConfiguration config = new ImageConfiguration(1.0, 1.0, 0.0, RenderMode.GRID_FIT, 1.0, false);
    ...
    void testSetImageConfigToNull() {
        ImageConfiguration config = new ImageConfiguration(1.0, 1.0, 0.0, RenderMode.CONFIGURED_SIZE, 1.0, false);
    ...
    @Test
    void testEntityCopy() {
        ImageConfiguration config = new ImageConfiguration(1.2, 1.8, 0.0, RenderMode.CONFIGURED_SIZE, 0.9, true);
    ...
    void testEntityEquals() {
        ImageConfiguration config1 = new ImageConfiguration(1.0, 1.0, 0.0, RenderMode.CONFIGURED_SIZE, 1.0, false);
        ImageConfiguration config2 = new ImageConfiguration(1.0, 1.0, 0.0, RenderMode.CONFIGURED_SIZE, 1.0, false);
    ...
    void testEntityToString() {
        ImageConfiguration config = new ImageConfiguration(1.2, 1.8, 0.0, RenderMode.CONFIGURED_SIZE, 0.8, true);
