// data/ui/menu-configs/macro-menus.js
...
(() => {
  ...
  window.WebGame.MenuConfigs.macroMenus = macroMenus;
  window.WebGame.MenuConfigs.getMacroMenu = getMacroMenu;
  window.WebGame.MenuConfigs.getMacroMenuKeys = getMacroMenuKeys;
