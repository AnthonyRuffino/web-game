// data/ui/menu-configs/skin-menus.js
...
(() => {
  ...
  window.WebGame.MenuConfigs.skinMenus = skinMenus;
  window.WebGame.MenuConfigs.getSkinMenu = getSkinMenu;
  window.WebGame.MenuConfigs.getSkinMenuKeys = getSkinMenuKeys;
