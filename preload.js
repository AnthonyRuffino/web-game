...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  dbGetAllCellChanges: (worldId) => ipcRenderer.invoke('db-get-all-cell-changes', worldId),
  dbMarkCellModified: (worldId, chunkX, chunkY, cellX, cellY, worldX, worldY) => ipcRenderer.invoke('db-mark-cell-modified', worldId, chunkX, chunkY, cellX, cellY, worldX, worldY),
  dbAddEntityToCell: (worldId, chunkX, chunkY, cellX, cellY, entityType, metadata) => ipcRenderer.invoke('db-add-entity-to-cell', worldId, chunkX, chunkY, cellX, cellY, entityType, metadata),
  dbRemoveEntityFromCell: (worldId, chunkX, chunkY, cellX, cellY, entityType) => ipcRenderer.invoke('db-remove-entity-from-cell', worldId, chunkX, chunkY, cellX, cellY, entityType),
